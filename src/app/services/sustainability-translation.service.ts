...
export class SustainabilityTranslationService {
  ...
  private async loadTranslations() {
    try {
      ...
      if (enTranslations && arTranslations) {
        ...
        console.log('Sustainability translations loaded from JSON files:', this.translations);
      }
    } catch (error) {
      console.warn('Failed to load Sustainability translations from JSON files:', error);
    ...
    this.translations = {
      en: {
        SUSTAINABILITY: {
          ...
          WELCOME: "Welcome to Sustainability",
          OVERVIEW: "Overview",
          METRICS: "Key Metrics",
      ...
      ar: {
        SUSTAINABILITY: {
          TITLE: "لوحة تحكم Sustainability",
          WELCOME: "مرحباً بك في Sustainability",
          OVERVIEW: "نظرة عامة",
  ...
  translate(key: string): string {
    try {
      ...
      if (!value) {
        console.warn(`Sustainability translation not found for key: ${key} in language: ${this.currentLanguage}`);
        return key;
      }
      
      return value;
    } catch (error) {
      console.error(`Sustainability translation error for key: ${key}`, error);
      return key;
    }
  }

...
export class DataManagementTranslationService {
  ...
  private async loadTranslations() {
    try {
      ...
      if (enTranslations && arTranslations) {
        ...
        console.log('Data Management translations loaded from JSON files:', this.translations);
      }
    } catch (error) {
      console.warn('Failed to load Data Management translations from JSON files:', error);
    ...
    this.translations = {
      en: {
        DATA_MANAGEMENT: {
          ...
          WELCOME: "Welcome to Data Management",
          OVERVIEW: "Overview",
          METRICS: "Key Metrics",
      ...
      ar: {
        DATA_MANAGEMENT: {
          TITLE: "لوحة تحكم Data Management",
          WELCOME: "مرحباً بك في Data Management",
          OVERVIEW: "نظرة عامة",
  ...
  translate(key: string): string {
    try {
      ...
      if (!value) {
        console.warn(`Data Management translation not found for key: ${key} in language: ${this.currentLanguage}`);
        return key;
      }
      
      return value;
    } catch (error) {
      console.error(`Data Management translation error for key: ${key}`, error);
      return key;
    }
  }

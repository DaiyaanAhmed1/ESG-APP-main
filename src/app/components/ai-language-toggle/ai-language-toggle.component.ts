...
@Component({
  selector: 'app-ai-language-toggle',
  standalone: true,
  ...
  styles: [`
    ...
    .ai-language-toggle:hover {
      background: #f1f5f9;
      color: #334155;
      border-color: #cbd5e1;
    }

    .ai-language-toggle:focus {
      outline: none;
      box-shadow: 0 0 0 2px #3b82f6;
    }

    .ai-language-toggle .icon {
      font-size: 1rem;
    }

    /* Dark mode styles */
    .dark-mode .ai-language-toggle {
      color: #94a3b8;
      border-color: #475569;
    }

    .dark-mode .ai-language-toggle:hover {
      background: #334155;
      color: #e2e8f0;
      border-color: #64748b;
    }
...
export class AiLanguageToggleComponent implements OnInit, OnDestroy {
  currentLanguage = 'en';
  isRTL = false;

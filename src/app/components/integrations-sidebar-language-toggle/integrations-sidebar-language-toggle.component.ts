...
@Component({
  selector: 'app-integrations-sidebar-language-toggle',
  standalone: true,
  imports: [CommonModule],
  template: `
    <button 
      class="integrations-language-toggle" 
  ...
  styles: [`
    ...
    .integrations-language-toggle:hover {
      background: #f1f5f9;
      color: #334155;
      border-color: #cbd5e1;
    }

    .integrations-language-toggle:focus {
      outline: none;
      box-shadow: 0 0 0 2px #3b82f6;
    }

    .integrations-language-toggle .icon {
      font-size: 1rem;
    }

    /* Dark mode styles */
    .dark-mode .integrations-language-toggle {
      color: #94a3b8;
      border-color: #475569;
    }

    .dark-mode .integrations-language-toggle:hover {
      background: #334155;
      color: #e2e8f0;
      border-color: #64748b;
    }
    ...
    /* RTL support */
    .integrations-language-toggle.rtl .icon {
      margin-left: 0.5rem;
      margin-right: 0;
    }
...
export class IntegrationsSidebarLanguageToggleComponent implements OnInit, OnDestroy {
  currentLanguage = 'en';
  isRTL = false;

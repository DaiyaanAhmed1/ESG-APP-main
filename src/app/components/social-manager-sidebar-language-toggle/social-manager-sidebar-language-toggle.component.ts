...
import { SocialManagerTranslationService } from '../../services/social-manager-translation.service';
import { Subscription } from 'rxjs';

@Component({
  selector: 'app-social-manager-sidebar-language-toggle',
  standalone: true,
...
export class SocialManagerSidebarLanguageToggleComponent implements OnInit, OnDestroy {
  currentLanguage = 'en';
  isRTL = false;
  sidebarCollapsed = false;
  private subscription?: Subscription;

  constructor(private translationService: SocialManagerTranslationService) {}

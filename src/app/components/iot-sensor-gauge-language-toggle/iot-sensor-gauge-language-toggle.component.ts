...
@Component({
  selector: 'app-iot-sensor-gauge-language-toggle',
  standalone: true,
  imports: [CommonModule],
  template: `
    <button 
      class="iot-sensor-gauge-language-toggle" 
  ...
  `,
  styles: [`
    .iot-sensor-gauge-language-toggle {
      display: flex;
      align-items: center;
      gap: 0.5rem;
      padding: 0.5rem 1rem;
    ...
    .iot-sensor-gauge-language-toggle:hover {
      background: rgba(255, 255, 255, 0.2);
      border-color: rgba(255, 255, 255, 0.3);
      transform: translateY(-1px);
    }

    .iot-sensor-gauge-language-toggle:focus {
      outline: none;
      box-shadow: 0 0 0 2px rgba(255, 255, 255, 0.3);
    }

    .iot-sensor-gauge-language-toggle .icon {
      font-size: 1rem;
    }

    /* RTL support */
    .iot-sensor-gauge-language-toggle.rtl .icon {
      margin-left: 0.5rem;
      margin-right: 0;
    }
...
export class IotSensorGaugeLanguageToggleComponent implements OnInit, OnDestroy {
  currentLanguage = 'en';
  isRTL = false;

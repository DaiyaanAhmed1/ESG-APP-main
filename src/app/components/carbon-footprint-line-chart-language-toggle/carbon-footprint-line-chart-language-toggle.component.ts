...
@Component({
  selector: 'app-carbon-footprint-line-chart-language-toggle',
  standalone: true,
  imports: [CommonModule],
  template: `
    <button 
      class="carbon-footprint-line-chart-language-toggle" 
  ...
  `,
  styles: [`
    .carbon-footprint-line-chart-language-toggle {
      display: flex;
      align-items: center;
      gap: 0.5rem;
      padding: 0.5rem 1rem;
    ...
    .carbon-footprint-line-chart-language-toggle:hover {
      background: rgba(255, 255, 255, 0.2);
      border-color: rgba(255, 255, 255, 0.3);
      transform: translateY(-1px);
    }

    .carbon-footprint-line-chart-language-toggle:focus {
      outline: none;
      box-shadow: 0 0 0 2px rgba(255, 255, 255, 0.3);
    }

    .carbon-footprint-line-chart-language-toggle .icon {
      font-size: 1rem;
    }

    /* RTL support */
    .carbon-footprint-line-chart-language-toggle.rtl .icon {
      margin-left: 0.5rem;
      margin-right: 0;
    }
...
export class CarbonFootprintLineChartLanguageToggleComponent implements OnInit, OnDestroy {
  currentLanguage = 'en';
  isRTL = false;

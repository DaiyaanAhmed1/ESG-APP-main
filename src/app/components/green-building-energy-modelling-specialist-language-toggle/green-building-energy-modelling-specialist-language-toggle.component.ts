...
@Component({
  selector: 'app-green-building-energy-modelling-specialist-language-toggle',
  standalone: true,
  imports: [CommonModule],
  template: `
    <button 
      class="green-building-energy-modelling-specialist-language-toggle" 
  ...
  `,
  styles: [`
    .green-building-energy-modelling-specialist-language-toggle {
      display: flex;
      align-items: center;
      gap: 0.5rem;
      padding: 0.5rem 1rem;
    ...
    .green-building-energy-modelling-specialist-language-toggle:hover {
      background: rgba(255, 255, 255, 0.2);
      border-color: rgba(255, 255, 255, 0.3);
      transform: translateY(-1px);
    }

    .green-building-energy-modelling-specialist-language-toggle:focus {
      outline: none;
      box-shadow: 0 0 0 2px rgba(255, 255, 255, 0.3);
    }

    .green-building-energy-modelling-specialist-language-toggle .icon {
      font-size: 1rem;
    }

    /* RTL support */
    .green-building-energy-modelling-specialist-language-toggle.rtl .icon {
      margin-left: 0.5rem;
      margin-right: 0;
    }
...
export class GreenBuildingEnergyModellingSpecialistLanguageToggleComponent implements OnInit, OnDestroy {
  currentLanguage = 'en';
  isRTL = false;

...
@Component({
  selector: 'app-ux-sidebar-language-toggle',
  standalone: true,
  imports: [CommonModule],
  template: `
    <button 
      class="ux-language-toggle" 
  ...
  styles: [`
    ...
    .ux-language-toggle:hover {
      background: #f1f5f9;
      color: #334155;
      border-color: #cbd5e1;
    }

    .ux-language-toggle:focus {
      outline: none;
      box-shadow: 0 0 0 2px #3b82f6;
    }

    .ux-language-toggle .icon {
      font-size: 1rem;
    }

    /* Dark mode styles */
    .dark-mode .ux-language-toggle {
      color: #94a3b8;
      border-color: #475569;
    }

    .dark-mode .ux-language-toggle:hover {
      background: #334155;
      color: #e2e8f0;
      border-color: #64748b;
    }
...
export class UxSidebarLanguageToggleComponent implements OnInit, OnDestroy {
  currentLanguage = 'en';
  isRTL = false;
  private subscription?: Subscription;

  constructor(private translationService: UxTranslationService) {}

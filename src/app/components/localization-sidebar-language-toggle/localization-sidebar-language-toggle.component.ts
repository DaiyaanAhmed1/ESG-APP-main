...
@Component({
  selector: 'app-localization-sidebar-language-toggle',
  standalone: true,
  imports: [CommonModule],
  template: `
    <button 
      class="localization-language-toggle" 
  ...
  styles: [`
    ...
    .localization-language-toggle:hover {
      background: #f1f5f9;
      color: #334155;
      border-color: #cbd5e1;
    }

    .localization-language-toggle:focus {
      outline: none;
      box-shadow: 0 0 0 2px #3b82f6;
    }

    .localization-language-toggle .icon {
      font-size: 1rem;
    }

    /* Dark mode styles */
    .dark-mode .localization-language-toggle {
      color: #94a3b8;
      border-color: #475569;
    }

    .dark-mode .localization-language-toggle:hover {
      background: #334155;
      color: #e2e8f0;
      border-color: #64748b;
    }
    ...
    /* RTL support */
    .localization-language-toggle.rtl .icon {
      margin-left: 0.5rem;
      margin-right: 0;
    }
...
export class LocalizationSidebarLanguageToggleComponent implements OnInit, OnDestroy {
  currentLanguage = 'en';
  isRTL = false;
  private subscription?: Subscription;

  constructor(private translationService: LocalizationTranslationService) {}

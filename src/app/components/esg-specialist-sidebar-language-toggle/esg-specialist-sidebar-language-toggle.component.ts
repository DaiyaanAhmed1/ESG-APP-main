...
@Component({
  selector: 'app-esg-specialist-sidebar-language-toggle',
  standalone: true,
  ...
  styles: [`
    ...
    /* RTL support */
    .edash-language-toggle.rtl .icon {
      margin-right: 0;
      margin-left: 0.75rem;
    }

    .edash-sidenav.collapsed .edash-language-toggle.rtl .icon {
      margin-left: 0;
    }

  `]
})
export class EsgSpecialistSidebarLanguageToggleComponent implements OnInit, OnDestroy {
  currentLanguage = 'en';
  isRTL = false;
  sidebarCollapsed = false;
  private subscription?: Subscription;

  constructor(private translationService: EsgSpecialistTranslationService) {}

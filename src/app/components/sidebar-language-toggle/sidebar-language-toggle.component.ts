...
@Component({
  selector: 'app-sidebar-language-toggle',
  standalone: true,
...
export class SidebarLanguageToggleComponent implements OnInit, OnDestroy {
  currentLanguage = 'en';
  isRTL = false;
  sidebarCollapsed = false;
  private subscription?: Subscription;

  constructor(private translationService: MarketingTranslationService) {}

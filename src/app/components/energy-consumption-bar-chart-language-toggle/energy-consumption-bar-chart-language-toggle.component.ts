...
@Component({
  selector: 'app-energy-consumption-bar-chart-language-toggle',
  standalone: true,
  imports: [CommonModule],
  template: `
    <button 
      class="energy-consumption-bar-chart-language-toggle" 
  ...
  `,
  styles: [`
    .energy-consumption-bar-chart-language-toggle {
      display: flex;
      align-items: center;
      gap: 0.5rem;
      padding: 0.5rem 1rem;
    ...
    .energy-consumption-bar-chart-language-toggle:hover {
      background: rgba(255, 255, 255, 0.2);
      border-color: rgba(255, 255, 255, 0.3);
      transform: translateY(-1px);
    }

    .energy-consumption-bar-chart-language-toggle:focus {
      outline: none;
      box-shadow: 0 0 0 2px rgba(255, 255, 255, 0.3);
    }

    .energy-consumption-bar-chart-language-toggle .icon {
      font-size: 1rem;
    }

    /* RTL support */
    .energy-consumption-bar-chart-language-toggle.rtl .icon {
      margin-left: 0.5rem;
      margin-right: 0;
    }
...
export class EnergyConsumptionBarChartLanguageToggleComponent implements OnInit, OnDestroy {
  currentLanguage = 'en';
  isRTL = false;
